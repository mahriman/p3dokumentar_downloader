    ...
    if($continue == true)
    {
        ...
        else 
        {
          if($change_id3_tags === TRUE) 
          {
            ...
            exec($eyed3_path . " -2 --encoding utf8 -a \"" . $id3_artist . "\" -A \"" . $id3_album . "\" -G " . $id3_genres . " -Y " . $download_year . " -t \"" . $item['pubdate'] . " - " . $item['title'] . "\" --remove-v1 --non-std-genres \"" . $download_path."/Disc ".$download_year."/".$download_filename . "\"", $eyed3_output, $eyed3_exit_status); 
